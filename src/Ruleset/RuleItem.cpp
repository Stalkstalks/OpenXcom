 ...
 */
RuleItem::RuleItem(const std::string &type, const std::string &game) : _type(type), _name(type), _terrorPrefix(""), _size(0.0), _costBuy(0), _costSell(0), _transferTime(24), _weight(999), _bigSprite(0), _floorSprite(-1), _handSprite(120), _bulletSprite(-1),
