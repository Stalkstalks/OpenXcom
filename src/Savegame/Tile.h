...
public:
	...
	inline MapData *getMapData(int part) const;
	...
	inline bool isUfoDoorOpen(int part) const;
	/// Close ufo door.
	int closeUfoDoor();
 ...
 * @return bool
 */
inline bool Tile::isUfoDoorOpen(int part) const
{
 ...
 */
inline MapData *Tile::getMapData(int part) const
{
