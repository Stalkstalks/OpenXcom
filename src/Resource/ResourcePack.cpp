...
void ResourcePack::loadGeoscapeResources(const std::string &gameFolder, const std::string &game)
{
	...
	else if (game == "xcom2")
	{
		...
		for (int i = 0; i < 16; ++i)
		{
			...
			_surfaces["TFTD_" + scrs[i]]->setPalette(_palettes["TFTD_PALETTES.DAT_0"]->getColors());
		}
...
/*
		...
		{
			short value[][10] = {{0, -720, 180, -480, 0, -480, -1, 0, 0, 0},
								{0, -720, 360, -480, 180, -480, -1, 0, 0, 0},
								{0, -720, 540, -480, 360, -480, -1, 0, 8, 0},
								{0, -720, 720, -480, 540, -480, -1, 0, 8, 0},
								{0, -720, 900, -480, 720, -480, -1, 0, 8, 0},
								{0, -720, 1080, -480, 900, -480, -1, 0, 0, 0},
								{0, -720, 1260, -480, 1080, -480, -1, 0, 0, 0},
								{0, -720, 1440, -480, 1260, -480, -1, 0, 8, 0},
								{0, -720, 1620, -480, 1440, -480, -1, 0, 8, 0},
								{0, -720, 1800, -480, 1620, -480, -1, 0, 0, 0},
								{0, -720, 1980, -480, 1800, -480, -1, 0, 0, 0},
								{0, -720, 2160, -480, 1980, -480, -1, 0, 8, 0},
								{0, -720, 2340, -480, 2160, -480, -1, 0, 8, 0},
								{0, -720, 2520, -480, 2340, -480, -1, 0, 0, 0},
								{0, -720, 2700, -480, 2520, -480, -1, 0, 0, 0},
								{0, -720, 2880, -480, 2700, -480, -1, 0, 8, 0},
								{180, -480, 180, -240, 0, -240, 0, -480, 0, 0},
								{360, -480, 360, -240, 180, -240, 180, -480, 0, 0},
								{540, -480, 540, -240, 360, -240, 360, -480, 8, 0},
								{720, -480, 720, -240, 540, -240, 540, -480, 8, 0},
								{900, -480, 900, -240, 720, -240, 720, -480, 0, 0},
								{1080, -480, 1080, -240, 900, -240, 900, -480, 0, 0},
								{1260, -480, 1260, -240, 1080, -240, 1080, -480, 8, 0},
								{1440, -480, 1440, -240, 1260, -240, 1260, -480, 8, 0},
								{1620, -480, 1620, -240, 1440, -240, 1440, -480, 0, 0},
								{1800, -480, 1800, -240, 1620, -240, 1620, -480, 0, 0},
								{1980, -480, 1980, -240, 1800, -240, 1800, -480, 8, 0},
								{2160, -480, 2160, -240, 1980, -240, 1980, -480, 8, 0},
								{2340, -480, 2340, -240, 2160, -240, 2160, -480, 0, 0},
								{2520, -480, 2520, -240, 2340, -240, 2340, -480, 0, 0},
								{2700, -480, 2700, -240, 2520, -240, 2520, -480, 8, 0},
								{2880, -480, 2880, -240, 2700, -240, 2700, -480, 8, 0},
								{180, -240, 180, 0, 0, 0, 0, -240, 0, 0},
								{360, -240, 360, 0, 180, 0, 180, -240, 0, 0},
								{540, -240, 540, 0, 360, 0, 360, -240, 8, 0},
								{720, -240, 720, 0, 540, 0, 540, -240, 8, 0},
								{900, -240, 900, 0, 720, 0, 720, -240, 0, 0},
								{1080, -240, 1080, 0, 900, 0, 900, -240, 0, 0},
								{1260, -240, 1260, 0, 1080, 0, 1080, -240, 8, 0},
								{1440, -240, 1440, 0, 1260, 0, 1260, -240, 8, 0},
								{1620, -240, 1620, 0, 1440, 0, 1440, -240, 0, 0},
								{1800, -240, 1800, 0, 1620, 0, 1620, -240, 0, 0},
								{1980, -240, 1980, 0, 1800, 0, 1800, -240, 8, 0},
								{2160, -240, 2160, 0, 1980, 0, 1980, -240, 8, 0},
								{2340, -240, 2340, 0, 2160, 0, 2160, -240, 0, 0},
								{2520, -240, 2520, 0, 2340, 0, 2340, -240, 0, 0},
								{2700, -240, 2700, 0, 2520, 0, 2520, -240, 8, 0},
								{2880, -240, 2880, 0, 2700, 0, 2700, -240, 8, 0},
								{0, 720, 180, 480, 0, 480, -1, 0, 0, 0},
								{0, 720, 360, 480, 180, 480, -1, 0, 0, 0},
								{0, 720, 540, 480, 360, 480, -1, 0, 8, 0},
								{0, 720, 720, 480, 540, 480, -1, 0, 8, 0},
								{0, 720, 900, 480, 720, 480, -1, 0, 8, 0},
			...
			Globe::loadPolygon(96, value, &_polygonsWater);
